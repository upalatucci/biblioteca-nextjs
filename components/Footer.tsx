      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-10 justify-items-center">
        ...
        <div>
          <a
            ...
            rel="noreferrer"
          >
            <Image width={168} height={41} src={VoloIcon} alt="volo continuo" />
          </a>
        </div>
        <div>
          <a
            ...
            rel="noreferrer"
          >
            <Image width={85} height={28} src={Esperia} alt="esperia" />
          </a>
        </div>
      </div>

      <p className="text-sm text-gray-150 mt-12">
        © Soka Gakkai. © Istituto Buddista Italiano Soka Gakkai. | Via di
        Bellagio 2/E 50141 Firenze FI | C.F. 94069310483 | P.I. 04935120487 |{" "}
        <a
          target="_blank"
