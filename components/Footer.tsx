...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-secondary text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24 font-sans print:hidden">
      <div className="flex flex-col md:flex-row">
        <div className="w-full lg:w-4/6 lg:mx-4 lg:pr-8">
          ...
          <p className="text-gray-400">
            TUTTI I SITI DELL&apos;ISTITUTO BUDDISTA ITALIANO SOKA GAKKAI:
          </p>
        </div>
